...
Public Class tCrystalReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApp1.tCrystalReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedtCrystalReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As tCrystalReport2 = New tCrystalReport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
