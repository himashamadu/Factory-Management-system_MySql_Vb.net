...
Public Class eCrystalReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApp1.eCrystalReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedeCrystalReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As eCrystalReport2 = New eCrystalReport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
