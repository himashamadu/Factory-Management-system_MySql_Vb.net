...
Public Class mCrystalReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApp1.mCrystalReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedmCrystalReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As mCrystalReport2 = New mCrystalReport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
